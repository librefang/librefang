...
- Validate OpenRouter snapshot structure and unique model identities before atomic replacement, while bounding and serializing the automated update PR flow. (@xiaomo)
