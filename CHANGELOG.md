...
- Run Docker CI for every build-context source change, share its amd64 cache with releases, fail immediately on container exit, and probe both liveness and readiness. (@xiaomo)
