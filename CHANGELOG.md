...
- Reconcile issue `has-pr` labels across every open PR on merge, close, reopen, and body edits, with one shared boundary-safe parser for shorthand and same-repository URL links. (@xiaomo)
