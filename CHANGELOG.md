...
- Incognito chat mode (`incognito: true` on message body / `--incognito` on CLI). Session messages and memory writes are dropped silently while memory reads remain full-access. Closes #4073. (@houko)
