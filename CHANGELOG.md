...
- Pass dashboard release metadata through environment variables, upload main builds only to stable releases, minimize lint permissions, and bound both workflow jobs. (@xiaomo)
