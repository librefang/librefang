...
- Coordinate manual CLI repairs with canonical releases, bound every job, verify the exact checksum asset set, and use an exact cosign workflow identity. (@xiaomo)
