...
- Restore consolidated release notifications against the unified Release workflow, with per-channel idempotency, verified external responses, and current job-status aggregation. (@xiaomo)
