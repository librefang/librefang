...
- Preserve `needs-info` when issue labeling falls back to triage, recognize breaking performance titles, avoid substring bug matches, and make thin-report detection language-neutral. (@xiaomo)
