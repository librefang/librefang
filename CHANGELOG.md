...
- Exercise the installer’s production PATH-refresh and restart-shell decisions directly, and make its parent-process fixture deterministic by requested PID. (@xiaomo)
