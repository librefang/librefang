...
- Restrict PR-title validation to read-only PR access, cancel superseded checks, bound runtime, and accurately document its case-neutral subject rule. (@xiaomo)
