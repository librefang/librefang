...
> AUR 계정 등록은 현재 일시적으로 사용할 수 없습니다. 따라서 LibreFang은
> 공식 pacman 저장소를 통해 서명된 패키지를 제공하고 있습니다.
...
패키지 세부 정보와 aarch64 지원은
[Arch 저장소 문서](../packaging/arch-repo/README.md)를 참조하세요.
