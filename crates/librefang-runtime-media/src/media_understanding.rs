...
mod tests {
    ...
    ///
    /// `frag_keyframe+empty_moov` puts the index up front, which is the one mp4 flavour that also demuxes over a pipe; the non-fragmented flavour #6747 is about has its own fixture below.
