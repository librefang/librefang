            ...
            <section>
              ...
              <div className="grid gap-2">
                {nodeTypesConfig.filter(n => ["start", "schedule", "webhook", "channel"].includes(n.type)).map(n => (
                  <button key={n.type} onClick={() => addNode(n.type)} className="flex items-center gap-3 p-3 rounded-xl border border-border-subtle bg-main/50 hover:border-brand transition-all text-left group">
