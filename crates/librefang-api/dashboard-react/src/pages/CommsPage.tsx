    ...
    <div className="flex flex-col gap-6 transition-colors duration-300">
      <header className="flex flex-col justify-between gap-4 sm:flex-row sm:items-end">
        <div>
          ...
          <h1 className="mt-2 text-3xl font-extrabold tracking-tight md:text-4xl">{t("nav.comms")}</h1>
          <p className="mt-1 text-text-dim font-medium max-w-2xl">{t("comms.subtitle")}</p>
        </div>
        <button
