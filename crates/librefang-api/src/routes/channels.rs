...
const CHANNEL_REGISTRY: &[ChannelMeta] = &[
    ...
    ChannelMeta {
        ...
        description: "WeCom intelligent bot (WebSocket long-connection)",
        category: "messaging", difficulty: "Easy", setup_time: "~2 min",
        ...
        setup_steps: &["Create an intelligent bot at WeCom admin console", "Select API mode and copy Bot ID and Secret", "Set WECOM_BOT_SECRET env var"],
