...
tui-agents-param-top-k-hint = top_k — 가장 가능성 높은 K개 토큰만 고려합니다. Anthropic, Gemini, Ollama, 로컬 서버 전용.
tui-agents-param-min-p = 최소 확률
tui-agents-param-min-p-hint = min_p — 최상위 토큰보다 훨씬 가능성이 낮은 토큰을 제외합니다. Ollama, vLLM, llama.cpp 전용.
tui-agents-param-repeat-penalty = 반복 페널티
tui-agents-param-repeat-penalty-hint = repeat_penalty — 최근 반복된 토큰을 억제합니다. 1.0은 끔. Ollama 및 로컬 서버 전용.
