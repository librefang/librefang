...
tui-init-provider-hints =   [↑↓/lh] 导航  [Enter] 选择  [Esc] 取消
...
tui-init-model-hints =   [↑↓/lh] 导航  [Enter] 选择  [Esc] 返回    * = 默认
...
tui-init-routing-pick-hints =   [↑↓/lh] 导航  [Enter] 选择  [Esc] 返回
...
tui-init-complete-hints =   [↑↓/lh] 导航  [Enter] 启动  [1/2/3] 快速选择
...
tui-extensions-hints-browse =   lh 导航 • Enter 安装 • / 搜索 • r 刷新
tui-extensions-hints-installed =   lh 导航 • d 删除 • r 刷新
tui-extensions-hints-health =   lh 导航 • r/Enter 重连 • 自动重连已启用
...
launcher-menu-hints = ↑↓/lh 导航  1-9 快速选择  enter 确认  q 退出
launcher-help-title = 所有命令
launcher-help-subtitle =   — q/Esc 返回
launcher-help-hints = ↑↓/lh 滚动  PgUp/PgDn  g/G 顶部/底部  q 返回
