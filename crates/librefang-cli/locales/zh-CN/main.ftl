...
tui-agents-hints-detail =   [s] 编辑 Skill  [m] 编辑 MCP  [n] 编辑频道  [w] 共享文件夹  [p] 模型参数  [c] 聊天  [k] 停止  [Esc] 返回
tui-agents-hints-detail =   [s] 编辑 Skill  [m] 编辑 MCP  [n] 编辑频道  [p] 模型参数  [h] 配置历史  [c] 聊天  [k] 停止  [Esc] 返回
