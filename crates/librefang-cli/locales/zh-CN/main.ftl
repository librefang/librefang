...
tui-agents-param-top-k-hint = top_k — 只考虑可能性最高的 K 个词元。仅限 Anthropic、Gemini、Ollama 和本地服务器。
tui-agents-param-min-p = 最小概率
tui-agents-param-min-p-hint = min_p — 丢弃远低于最高词元概率的词元。仅限 Ollama、vLLM 和 llama.cpp。
tui-agents-param-repeat-penalty = 重复惩罚
tui-agents-param-repeat-penalty-hint = repeat_penalty — 抑制最近重复的词元；1.0 为关闭。仅限 Ollama 和本地服务器。
