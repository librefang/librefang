...
tui-agents-workspaces-row-dropped = A row with an empty name or path will not be saved. Press s again to save the rest.
...
tui-agents-workspaces-mode-invalid = "{ $value }" is not a folder mode; the previous one was kept. Use "readonly" or "readwrite".
