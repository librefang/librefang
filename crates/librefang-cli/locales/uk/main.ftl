...
tui-agents-param-top-k-hint = top_k — враховувати лише K найімовірніших токенів. Лише Anthropic, Gemini, Ollama і локальні сервери.
tui-agents-param-min-p = Мінімальна ймовірність
tui-agents-param-min-p-hint = min_p — відкидає токени, значно менш імовірні за найкращий. Лише Ollama, vLLM і llama.cpp.
tui-agents-param-repeat-penalty = Штраф за повторення
tui-agents-param-repeat-penalty-hint = repeat_penalty — стримує нещодавно повторені токени; 1.0 вимикає. Лише Ollama і локальні сервери.
