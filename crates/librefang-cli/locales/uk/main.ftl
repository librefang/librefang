...
tui-agents-workspaces-row-dropped = Рядок з порожньою назвою або шляхом не буде збережено. Натисніть s ще раз, щоб зберегти решту.
...
tui-agents-workspaces-mode-invalid = "{ $value }" не є режимом теки; попередній збережено. Використовуйте "readonly" або "readwrite".
