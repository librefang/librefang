...
use self::message::{
    ...
    sanitize_for_memory, sanitize_sender_label, sanitize_tool_result_content,
    strip_prior_image_data, strip_processed_image_data,
};
use self::model::{stable_prefix_mode_enabled, UNKNOWN_MODEL_CONTEXT_WINDOW};
use self::retry::{call_with_retry, stream_with_retry};
use self::text_recovery::{
    looks_like_hallucinated_action, recover_text_tool_calls, user_message_has_action_intent,
};
...
mod tests {
    ...
    use super::message::ACCUMULATED_TEXT_MAX_BYTES;
    use super::model::needs_qualified_model_id;
    use super::retry::{BASE_RETRY_DELAY_MS, MAX_RETRIES};
    use super::text_recovery::{parse_dash_dash_args, parse_json_tool_call_object};
