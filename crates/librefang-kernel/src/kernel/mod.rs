                                ...
                                match parsed {
                                    Some(mut disk_manifest) => {
                                        ...
                                        if changed {
                                            ...
                                            // (stamped at activation, see ~line 8595) while the TOML
                                            // only carries the bare "{manifest.name}". Letting the
                                            // disk version overwrite the canonical name here would
                                            // break `find_by_name` lookups, channel routing, and
                                            // peer discovery — all of which key on the colon form.
                                            // Mirrors the runtime hot-reload path lower in this file.
