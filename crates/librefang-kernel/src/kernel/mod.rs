...
impl LibreFangKernel {
    ...
    fn build_deferred_tool_exec_context<'a>(
        ...
        librefang_runtime::tool_runner::ToolExecContext {
            ...
            // #6458: restore the provenance captured at defer time so the resumed execution filters the child env exactly as the live path would have.
            // Pre-existing payloads without the field deserialize to the strict `HandDeclared` default.
