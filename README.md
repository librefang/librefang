...
**Hands** are pre-built autonomous capability packages that run independently, on schedules, without prompting. 17 bundled:
...
librefang-runtime           Agent loop, 16 LLM drivers, 60+ tools, WASM sandbox, MCP, A2A
librefang-api               140+ REST/WS/SSE endpoints, OpenAI-compatible API, dashboard
librefang-channels          57 messaging adapters with rate limiting, DM/group policies
...
librefang-hands             17 autonomous Hands, HAND.toml parser, lifecycle management
