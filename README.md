...
librefang-wire        OFP P2P protocol, HMAC-SHA256 mutual auth (plaintext wire — run cross-network federation behind a WireGuard / Tailscale / SSH overlay; details: https://docs.librefang.ai/architecture/ofp-wire)
