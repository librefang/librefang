...
It immediately found ten channel labels (`fld_discord`, `fld_slack`, `fld_telegram` and seven more) for fields `ChannelsConfig` no longer has; they were dead in all five locales and are removed (#8485) (@houko)
