...
The binaries are not notarized and do not use the hardened runtime; the first update from an ad-hoc build still needs the grants re-added once (#8483) (@houko)
