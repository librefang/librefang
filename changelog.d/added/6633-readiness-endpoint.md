...
Changing `/api/health` itself would have conflated liveness with readiness and restart-looped pods through recoverable storage incidents, so the two contracts are now separate endpoints (#6633) (@houko)
