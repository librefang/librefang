...
Both lists are always present, so a skill that declares nothing reports empty arrays rather than a missing key, which a client can tell apart from "unknown". (#8473, #8445) (@houko)
