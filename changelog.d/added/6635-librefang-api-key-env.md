...
An empty value is ignored with a warning rather than treated as "clear the key", because a Secret key that exists but is unset would otherwise disarm bearer authentication on a non-loopback bind (#6635) (@houko)
