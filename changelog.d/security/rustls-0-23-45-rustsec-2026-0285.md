...
Lockfile only. `aws-lc-rs`, `aws-lc-sys` and `rustls-webpki` move with it because 0.23.45 requires them to; no `Cargo.toml` changes and no new dependencies (#8378) (@houko)
