...
## PR Workflow
- Create feature branch from `main` (e.g. `feat/provider-setup-graceful-degradation`)
- Design specs (`docs/superpowers/specs/`) are working documents — do NOT commit them to the PR
- Use spec content for the PR description body instead
