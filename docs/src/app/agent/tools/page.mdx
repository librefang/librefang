...
| `media_transcribe(audio_or_video, language?, prompt?)` | Speech-to-text on an audio file, or a video container's audio track (extracted server-side). Rejects unrecognised file extensions. |
