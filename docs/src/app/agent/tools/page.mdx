...
The channel, the conversation and the bot account all come from the turn being handled, and the recipient must already appear in that conversation's roster — someone the daemon has seen speak there, as listed by `channel_members`.
