...
| PUT | `/api/agents/&lbrace;id&rbrace;/update` | Update agent config |
| PUT | `/api/agents/&lbrace;id&rbrace;/mode` | Set agent mode (Stable/Normal) |
...
| POST | `/api/providers/&lbrace;name&rbrace;/test` | Test provider connectivity |
| **Skills & Marketplace** | | |
