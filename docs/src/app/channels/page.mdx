...
- [Core Messaging](/channels/core) — Telegram, Discord, Slack, WhatsApp, WeChat, Signal, Matrix, Email, WebChat
- [Enterprise](/channels/enterprise) — Teams, Mattermost, Google Chat, Webex, Feishu, Rocket.Chat, Zulip, Flock, Twist, Pumble, Guilded
- [Social & Community](/channels/social) — Reddit, Mastodon, Bluesky, LinkedIn, Twitch, Discourse, Gitter, Revolt, Keybase, Nostr
- [Integrations & Protocols](/channels/integrations) — LINE, Viber, Messenger, DingTalk, QQ, WeCom, Threema, IRC, XMPP, MQTT, Ntfy, Gotify, Nextcloud, Mumble, Webhook, Voice
- [Custom Adapters](/channels/custom) — Writing your own adapter
