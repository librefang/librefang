...
| QQ | Bot API long-polling | `QQ_BOT_TOKEN`, `QQ_BOT_APPID` | `Custom("qq")` |
| WeCom / WeChat Work | Enterprise API webhook | `WECOM_CORP_ID`, `WECOM_AGENT_ID`, `WECOM_SECRET` | `Custom("wecom")` |
| WeChat (Personal) | iLink Bot API long-polling | _(QR code login)_ | `WeChat` |
...
| MQTT | MQTT v3.1.1/v5 pub/sub | `MQTT_HOST`, `MQTT_USERNAME`, `MQTT_PASSWORD` (optional) | `Custom("mqtt")` |
