...
```bash
export WECOM_CORP_ID=your-corp-id             # Environment variable
export WECOM_AGENT_ID=your-agent-id
export WECOM_SECRET=your-app-secret
librefang vault set WECOM_CORP_ID             # Encrypted vault (recommended)
librefang vault set WECOM_AGENT_ID
librefang vault set WECOM_SECRET
