...
> **子页面：** [命令参考](/zh/cli/commands) | [示例与指南](/zh/cli/examples)
...
有关 Agent、Hand、工作流、触发器、技能、通道和配置的详细命令参考，请参阅 **[CLI 命令参考](/zh/cli/commands)**。
...
有关使用示例、迁移指南和 MCP 集成说明，请参阅 **[CLI 示例与指南](/zh/cli/examples)**。
