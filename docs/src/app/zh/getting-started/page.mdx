...
[Arch 仓库文档](https://github.com/librefang/librefang/blob/main/packaging/arch-repo/README.md)。
...
```bash
sudo pacman -S librefang-desktop-bin
```

桌面软件包仅支持 x86_64。在 aarch64 上，请安装 `librefang-bin`，并通过
`http://127.0.0.1:4545/` 使用 Web Dashboard。
