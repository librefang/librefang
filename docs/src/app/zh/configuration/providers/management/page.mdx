...
| 2 | `sonnet` | Claude Sonnet 4 | anthropic | 智能 | 200,000 | 64,000 | $3.00 | $15.00 | 是 | 是 |
...
| Medium | `100 <= score < 500` | `sonnet` |
| Complex | `score >= 500` | `sonnet` |
...
- **`resolve_aliases()`** 将别名展开为规范 ID（例如 `"sonnet"` 变为 `"sonnet"`）
...
```
> Cost: $0.0042 | Tokens: 1,200 in / 340 out | Model: sonnet
```
