...
- [核心消息渠道](/zh/channels/core) -- Telegram、Discord、Slack、WhatsApp、微信、Signal、Matrix、Email、WebChat
- [企业协作](/zh/channels/enterprise) -- Teams、Mattermost、Google Chat、Webex、飞书、Rocket.Chat、Zulip、Flock、Twist、Pumble、Guilded
- [社交与社区](/zh/channels/social) -- Reddit、Mastodon、Bluesky、LinkedIn、Twitch、Discourse、Gitter、Revolt、Keybase、Nostr
- [集成与协议](/zh/channels/integrations) -- LINE、Viber、Messenger、Threema、钉钉、QQ、企业微信、IRC、XMPP、MQTT、Ntfy、Gotify、Nextcloud、Mumble、Webhook、Voice
- [自定义适配器](/zh/channels/custom) -- 编写自定义适配器
