...
- Key features: 42 channels, 60 tools, 28 providers, 130+ models
...
1. Install v0.7.0 from the release
2. Tag v0.7.1 and push
3. Wait for release workflow to complete
4. Open the v0.7.0 app — after 10 seconds it should:
