...
BossFang provides SDKs and client libraries in multiple languages.

---

## Overview

BossFang provides official SDK support for multiple programming languages for easy integration into your applications.
...
BossFang provides an OpenAI-compatible API that can be used directly with OpenAI client libraries.
