...
<Note>
AUR account registration is temporarily unavailable. LibreFang currently
publishes signed Arch packages through its official pacman repository.
</Note>
...
See the [Arch repository documentation](https://github.com/librefang/librefang/blob/main/packaging/arch-repo/README.md)
