...
Practical examples, migration guides, and integration instructions for the BossFang CLI.
...
- Converts agent configurations, YAML manifests, and settings from the source framework into BossFang format.
...
- Exposes running BossFang agents as MCP tools via JSON-RPC 2.0 over stdin/stdout with Content-Length framing.
