...
7. Configure the messaging endpoint in Azure to point to your BossFang instance's public URL (e.g., `https://your-domain.com:4545/channels/teams/webhook`).
...
3. Configure a Chat app in the Google Chat API settings, selecting the **HTTP endpoint** connection type. Set the endpoint URL to your BossFang instance (e.g., `https://your-domain.com:4545/channels/google_chat/webhook`).
...
4. Configure event subscriptions to point to your BossFang instance's webhook URL (e.g., `https://your-domain.com:4545/channels/feishu/webhook`).
5. Set environment variables:
