...
2. Start (or restart) the BossFang daemon.
...
If you want BossFang to truncate rather than split long messages for a specific
...
The default is `true` for Discord and the Telegram sidecar adapter.
