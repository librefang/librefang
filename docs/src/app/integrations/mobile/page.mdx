# BossFang Mobile (iOS & Android)

BossFang mobile is a **thin-client dashboard** for iOS and Android built with [Tauri 2](https://v2.tauri.app/). The mobile app connects to a remote `librefang` daemon running on your home server, VPS, NAS, or desktop — it does not embed the daemon itself.
...
This is intentional. BossFang runs cron jobs, autodream, channel adapters, and triggers 24 × 7. iOS and Android impose strict background-execution limits that make continuous daemon uptime impossible on a phone.
