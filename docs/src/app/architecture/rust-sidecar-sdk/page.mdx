...
`sdk/rust/librefang-sidecar/` is the first-party Rust SDK for writing BossFang channel adapters as out-of-process binaries.
...
- **Process restart is BossFang's job.**
