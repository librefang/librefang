# BossFang Security Architecture
...
system in the BossFang Agent Operating System.  All struct names, function
...
BossFang implements **defense-in-depth** security.  No single mechanism is
...
BossFang uses capability-based security.  An agent can only perform actions
...
The BossFang Wire Protocol (OFP) uses HMAC-SHA256 with nonce-based mutual
