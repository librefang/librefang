...
> **Sub-pages:** [Command Reference](/cli/commands) | [Examples & Guides](/cli/examples)
...
For detailed command references for agents, hands, workflows, triggers, skills, channels, and config, see **[CLI Command Reference](/cli/commands)**.
...
For usage examples, migration guides, and MCP integration instructions, see **[CLI Examples & Guides](/cli/examples)**.
