...
The available models are a property of your account rather than of LibreFang.
LibreFang asks the EveryAPI CLI credential process for the current gateway and relay credential, then loads the account's live catalog.
