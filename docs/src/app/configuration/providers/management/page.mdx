...
| 2 | `sonnet` | Claude Sonnet 4 | anthropic | Smart | 200,000 | 64,000 | $3.00 | $15.00 | Yes | Yes |
...
[[agents]]
name = "production-bot"
pinned_model = "sonnet"  # never auto-routed
```
...
- **`resolve_aliases()`** expands aliases to canonical IDs (e.g., `"sonnet"` becomes `"sonnet"`)
