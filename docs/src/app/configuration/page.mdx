...
| `model` | string | `"sonnet"` | Model identifier. Aliases like `sonnet`, `haiku`, `gpt-4o`, `gemini-flash` are resolved by the model catalog. |
...
| `medium_model` | `"sonnet"` | Model for medium-complexity queries. |
| `complex_model` | `"sonnet"` | Model for complex queries. |
