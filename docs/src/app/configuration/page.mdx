...
Kimi/Moonshot models always send `thinking: disabled` (a multi-turn tool-call requirement, not a preference), DeepSeek R1 has no wire toggle, and the Anthropic / Gemini / Ollama drivers continue to use `budget_tokens`.
