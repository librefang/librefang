...
**CRITICAL NOTICE: All email-related operations (sending, modifying, or deleting emails) via services like Gmail, Resend, Mailgun, etc., are currently DISABLED. Do not attempt to use these routes for sending messages.**
